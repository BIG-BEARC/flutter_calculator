...
//  '$Route_TapboxC ': (context) => TapboxC (),
  ...
  '$Route_SwitchAndCheckBoxTestRoute': (context) =>
  ...
  '$Route_SingleChildScrollViewTestRoute': (context) =>
  ...
  '$Route_FutureBuilderAndStreamBuilder': (context) =>
...
/*  '$Route_AnimationDemo': (context) {
    return MaterialPageRoute(
        settings: RouteSettings(name: 'AnimationDemo'),
